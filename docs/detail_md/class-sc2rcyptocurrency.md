...
## Class sc2r:CyptoCurrency


#### Tree


* [sc2r:File](class-sc2rfile.md)
...
#### URI
http://cs.unu.edu/sc2r#CyptoCurrency
...
#### Instances of sc2r:CyptoCurrency can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:CyptoCurrency" href="class-sc2rcyptocurrency.md" class="rdfclass">sc2r:CyptoCurrency</a></span>
            </th>
        </tr>       
