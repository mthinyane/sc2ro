...
* [sc2r:PhysicalResource](class-sc2rphysicalresource.md)
    ...
    * sc2r:StorageAsset
        ...
        * [sc2r:ExternalHardDrive](class-sc2rexternalharddrive.md) 

        * [sc2r:SDCard](class-sc2rsdcard.md) 

        * [sc2r:USBDrive](class-sc2rusbdrive.md) 
...
#### URI
http://cs.unu.edu/sc2r#StorageAsset
...
#### Instances of sc2r:StorageAsset can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:StorageAsset" href="class-sc2rstorageasset.md" class="rdfclass">sc2r:StorageAsset</a></span>
            </th>
        </tr>       
