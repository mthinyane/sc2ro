...
#### URI
http://cs.unu.edu/sc2r#SexualAssault
...
#### Instances of sc2r:SexualAssault can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:SexualAssault" href="class-sc2rsexualassault.md" class="rdfclass">sc2r:SexualAssault</a></span>
            </th>
        </tr>       
