...
#### URI
http://cs.unu.edu/sc2r#IntrusionDetection
...
#### Instances of sc2r:IntrusionDetection can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:IntrusionDetection" href="class-sc2rintrusiondetection.md" class="rdfclass">sc2r:IntrusionDetection</a></span>
            </th>
        </tr>       
