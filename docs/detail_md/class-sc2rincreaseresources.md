...
#### URI
http://cs.unu.edu/sc2r#IncreaseResources
...
#### Instances of sc2r:IncreaseResources can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:IncreaseResources" href="class-sc2rincreaseresources.md" class="rdfclass">sc2r:IncreaseResources</a></span>
            </th>
        </tr>       
