...
#### URI
http://cs.unu.edu/sc2r#Reputation
...
#### Instances of sc2r:Reputation can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:Reputation" href="class-sc2rreputation.md" class="rdfclass">sc2r:Reputation</a></span>
            </th>
        </tr>       
