...
## Class sc2r:PsychographicHacking
...
* [sc2r:InfluenceThreat](class-sc2rinfluencethreat.md)
    ...
    * sc2r:PsychographicHacking
        ...
        * [sc2r:BandwagonEffect](class-sc2rbandwagoneffect.md) 

        * [sc2r:DarkAdvertising](class-sc2rdarkadvertising.md) 

        * [sc2r:Microtargeting](class-sc2rmicrotargeting.md) 
...
#### URI
http://cs.unu.edu/sc2r#PsychographicHacking
...
#### Instances of sc2r:PsychographicHacking can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:PsychographicHacking" href="class-sc2rpsychographichacking.md" class="rdfclass">sc2r:PsychographicHacking</a></span>
            </th>
        </tr>       
