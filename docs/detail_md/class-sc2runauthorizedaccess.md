...
* [sc2r:AuthenticationThreat](class-sc2rauthenticationthreat.md)
    ...
    * sc2r:UnauthorizedAccess
        ...
        * [sc2r:NetworkIntrusion](class-sc2rnetworkintrusion.md) 

        * [sc2r:Piggybacking](class-sc2rpiggybacking.md) 
...
#### URI
http://cs.unu.edu/sc2r#UnauthorizedAccess
...
#### Instances of sc2r:UnauthorizedAccess can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:UnauthorizedAccess" href="class-sc2runauthorizedaccess.md" class="rdfclass">sc2r:UnauthorizedAccess</a></span>
            </th>
        </tr>       
