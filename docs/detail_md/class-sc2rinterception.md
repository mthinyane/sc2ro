...
* [sc2r:ConfidentialityThreat](class-sc2rconfidentialitythreat.md)
    ...
    * sc2r:Interception
        ...
        * [sc2r:Eavesdropping](class-sc2reavesdropping.md) 
...
#### URI
http://cs.unu.edu/sc2r#Interception
...
#### Instances of sc2r:Interception can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:Interception" href="class-sc2rinterception.md" class="rdfclass">sc2r:Interception</a></span>
            </th>
        </tr>       
