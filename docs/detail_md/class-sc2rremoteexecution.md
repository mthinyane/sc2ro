...
#### URI
http://cs.unu.edu/sc2r#RemoteExecution
...
#### Instances of sc2r:RemoteExecution can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:RemoteExecution" href="class-sc2rremoteexecution.md" class="rdfclass">sc2r:RemoteExecution</a></span>
            </th>
        </tr>       
