...
* [sc2r:PrepareMeasure](class-sc2rpreparemeasure.md)
    ...
    * sc2r:AnticipateMeasure
        ...
        * [sc2r:AttitudinalMeasure](class-sc2rattitudinalmeasure.md) 

        * [sc2r:Awareness](class-sc2rawareness.md) 

        * [sc2r:RecoveryPlan](class-sc2rrecoveryplan.md) 

        * [sc2r:RedundancyMeasure](class-sc2rredundancymeasure.md) 

        * [sc2r:Training](class-sc2rtraining.md) 
...
#### URI
http://cs.unu.edu/sc2r#AnticipateMeasure
...
#### Instances of sc2r:AnticipateMeasure can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:AnticipateMeasure" href="class-sc2ranticipatemeasure.md" class="rdfclass">sc2r:AnticipateMeasure</a></span>
            </th>
        </tr>       
