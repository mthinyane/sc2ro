...
* [sc2r:AnticipateMeasure](class-sc2ranticipatemeasure.md)
    ...
    * sc2r:Awareness
        ...
        * [sc2r:AssetInventory](class-sc2rassetinventory.md) 

        * [sc2r:DigitalFootprint](class-sc2rdigitalfootprint.md) 
...
#### URI
http://cs.unu.edu/sc2r#Awareness
...
#### Instances of sc2r:Awareness can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:Awareness" href="class-sc2rawareness.md" class="rdfclass">sc2r:Awareness</a></span>
            </th>
        </tr>       
