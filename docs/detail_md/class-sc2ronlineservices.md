...
#### URI
http://cs.unu.edu/sc2r#OnlineServices
...
#### Instances of sc2r:OnlineServices can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:OnlineServices" href="class-sc2ronlineservices.md" class="rdfclass">sc2r:OnlineServices</a></span>
            </th>
        </tr>       
