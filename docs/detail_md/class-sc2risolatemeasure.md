...
#### URI
http://cs.unu.edu/sc2r#IsolateMeasure
...
#### Instances of sc2r:IsolateMeasure can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:IsolateMeasure" href="class-sc2risolatemeasure.md" class="rdfclass">sc2r:IsolateMeasure</a></span>
            </th>
        </tr>       
