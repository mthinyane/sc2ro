...
#### URI
http://cs.unu.edu/sc2r#ExternalHardDrive
...
#### Instances of sc2r:ExternalHardDrive can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:ExternalHardDrive" href="class-sc2rexternalharddrive.md" class="rdfclass">sc2r:ExternalHardDrive</a></span>
            </th>
        </tr>       
