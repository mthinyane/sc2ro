...
* [sc2r:Resource](class-sc2rresource.md)
    ...
    * sc2r:PhysicalResource
        ...
        * [sc2r:NetworkEquipment](class-sc2rnetworkequipment.md) 

        * [sc2r:StorageAsset](class-sc2rstorageasset.md) 
...
#### URI
http://cs.unu.edu/sc2r#PhysicalResource
...
#### Instances of sc2r:PhysicalResource can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:PhysicalResource" href="class-sc2rphysicalresource.md" class="rdfclass">sc2r:PhysicalResource</a></span>
            </th>
        </tr>       
