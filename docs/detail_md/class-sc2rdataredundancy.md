...
#### URI
http://cs.unu.edu/sc2r#DataRedundancy
...
#### Instances of sc2r:DataRedundancy can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:DataRedundancy" href="class-sc2rdataredundancy.md" class="rdfclass">sc2r:DataRedundancy</a></span>
            </th>
        </tr>       
