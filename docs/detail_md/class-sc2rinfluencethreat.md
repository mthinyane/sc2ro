...
* [sc2r:CognitiveThreat](class-sc2rcognitivethreat.md)
    ...
    * sc2r:InfluenceThreat
        ...
        * [sc2r:Coercion](class-sc2rcoercion.md) 

        * [sc2r:Extortion](class-sc2rextortion.md) 

        * [sc2r:InformationOverload](class-sc2rinformationoverload.md) 

        * [sc2r:PsychographicHacking](class-sc2rpsychographichacking.md) 

        * [sc2r:Scareware](class-sc2rscareware.md) 

        * [sc2r:SocialEngineering](class-sc2rsocialengineering.md) 
...
#### URI
http://cs.unu.edu/sc2r#InfluenceThreat
...
#### Instances of sc2r:InfluenceThreat can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:InfluenceThreat" href="class-sc2rinfluencethreat.md" class="rdfclass">sc2r:InfluenceThreat</a></span>
            </th>
        </tr>       
