...
## Class sc2r:MultiFactorAuthentication
...
#### URI
http://cs.unu.edu/sc2r#MultiFactorAuthentication
...
#### Instances of sc2r:MultiFactorAuthentication can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:MultiFactorAuthentication" href="class-sc2rmultifactorauthentication.md" class="rdfclass">sc2r:MultiFactorAuthentication</a></span>
            </th>
        </tr>       
