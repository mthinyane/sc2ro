...
## Class sc2r:InformationOverload
...
#### URI
http://cs.unu.edu/sc2r#InformationOverload
...
#### Instances of sc2r:InformationOverload can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:InformationOverload" href="class-sc2rinformationoverload.md" class="rdfclass">sc2r:InformationOverload</a></span>
            </th>
        </tr>       
