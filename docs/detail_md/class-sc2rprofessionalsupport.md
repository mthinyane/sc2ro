...
## Class sc2r:ProfessionalSupport
...
#### URI
http://cs.unu.edu/sc2r#ProfessionalSupport
...
#### Instances of sc2r:ProfessionalSupport can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:ProfessionalSupport" href="class-sc2rprofessionalsupport.md" class="rdfclass">sc2r:ProfessionalSupport</a></span>
            </th>
        </tr>       
