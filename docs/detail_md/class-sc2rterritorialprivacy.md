...
#### URI
http://cs.unu.edu/sc2r#TerritorialPrivacy
...
#### Instances of sc2r:TerritorialPrivacy can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:TerritorialPrivacy" href="class-sc2rterritorialprivacy.md" class="rdfclass">sc2r:TerritorialPrivacy</a></span>
            </th>
        </tr>       
