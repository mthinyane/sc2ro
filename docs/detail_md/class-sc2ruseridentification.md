...
#### URI
http://cs.unu.edu/sc2r#UserIdentification
...
#### Instances of sc2r:UserIdentification can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:UserIdentification" href="class-sc2ruseridentification.md" class="rdfclass">sc2r:UserIdentification</a></span>
            </th>
        </tr>       
