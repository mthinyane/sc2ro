...
#### URI
http://cs.unu.edu/sc2r#DisruptedIncome
...
#### Instances of sc2r:DisruptedIncome can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:DisruptedIncome" href="class-sc2rdisruptedincome.md" class="rdfclass">sc2r:DisruptedIncome</a></span>
            </th>
        </tr>       
