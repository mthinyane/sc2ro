...
## Class sc2r:InfrastructureResource
...
* [sc2r:Resource](class-sc2rresource.md)
    ...
    * sc2r:InfrastructureResource
        ...
        * [sc2r:Electricity](class-sc2relectricity.md) 

        * [sc2r:InternetConnectivity](class-sc2rinternetconnectivity.md) 
...
#### URI
http://cs.unu.edu/sc2r#InfrastructureResource
...
#### Instances of sc2r:InfrastructureResource can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:InfrastructureResource" href="class-sc2rinfrastructureresource.md" class="rdfclass">sc2r:InfrastructureResource</a></span>
            </th>
        </tr>       
