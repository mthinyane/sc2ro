...
#### URI
http://cs.unu.edu/sc2r#Fact-checking
...
#### Instances of sc2r:Fact-checking can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:Fact-checking" href="class-sc2rfact-checking.md" class="rdfclass">sc2r:Fact-checking</a></span>
            </th>
        </tr>       
