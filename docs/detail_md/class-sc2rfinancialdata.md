...
#### URI
http://cs.unu.edu/sc2r#FinancialData
...
#### Instances of sc2r:FinancialData can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:FinancialData" href="class-sc2rfinancialdata.md" class="rdfclass">sc2r:FinancialData</a></span>
            </th>
        </tr>       
