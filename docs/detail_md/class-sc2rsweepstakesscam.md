...
#### URI
http://cs.unu.edu/sc2r#SweepstakesScam
...
- [sc2r:TheftThreat](class-sc2rtheftthreat.md)
...
#### Instances of sc2r:SweepstakesScam can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:SweepstakesScam" href="class-sc2rsweepstakesscam.md" class="rdfclass">sc2r:SweepstakesScam</a></span>
            </th>
        </tr>       
