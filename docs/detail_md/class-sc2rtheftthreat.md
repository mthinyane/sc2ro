...
* [sc2r:PersonalThreat](class-sc2rpersonalthreat.md)
    ...
    * sc2r:TheftThreat
        ...
        * [sc2r:Fraud](class-sc2rfraud.md) 

        * [sc2r:IdentityTheft](class-sc2ridentitytheft.md) 

        * [sc2r:Scam](class-sc2rscam.md) 
...
#### URI
http://cs.unu.edu/sc2r#TheftThreat
...
#### Instances of sc2r:TheftThreat can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:TheftThreat" href="class-sc2rtheftthreat.md" class="rdfclass">sc2r:TheftThreat</a></span>
            </th>
        </tr>       
