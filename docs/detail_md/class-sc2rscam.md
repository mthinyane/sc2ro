...
* [sc2r:TheftThreat](class-sc2rtheftthreat.md)
    ...
    * sc2r:Scam
        ...
        * [sc2r:FakeGiveways](class-sc2rfakegiveways.md) 

        * [sc2r:SweepstakesScam](class-sc2rsweepstakesscam.md) 
...
#### Instances of sc2r:Scam can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:Scam" href="class-sc2rscam.md" class="rdfclass">sc2r:Scam</a></span>
            </th>
        </tr>       
