...
#### URI
http://cs.unu.edu/sc2r#WhatAboutism
...
#### Instances of sc2r:WhatAboutism can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:WhatAboutism" href="class-sc2rwhataboutism.md" class="rdfclass">sc2r:WhatAboutism</a></span>
            </th>
        </tr>       
