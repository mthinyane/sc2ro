...
## Class sc2r:NonRepudiationThreat
...
#### URI
http://cs.unu.edu/sc2r#NonRepudiationThreat
...
#### Instances of sc2r:NonRepudiationThreat can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:NonRepudiationThreat" href="class-sc2rnonrepudiationthreat.md" class="rdfclass">sc2r:NonRepudiationThreat</a></span>
            </th>
        </tr>       
