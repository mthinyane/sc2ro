...
#### URI
http://cs.unu.edu/sc2r#DataError
...
#### Instances of sc2r:DataError can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:DataError" href="class-sc2rdataerror.md" class="rdfclass">sc2r:DataError</a></span>
            </th>
        </tr>       
