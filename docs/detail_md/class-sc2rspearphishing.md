...
* [sc2r:Phishing](class-sc2rphishing.md)
    ...
    * sc2r:SpearPhishing
        ...
        * [sc2r:Whaling](class-sc2rwhaling.md) 
...
#### URI
http://cs.unu.edu/sc2r#SpearPhishing
...
#### Instances of sc2r:SpearPhishing can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:SpearPhishing" href="class-sc2rspearphishing.md" class="rdfclass">sc2r:SpearPhishing</a></span>
            </th>
        </tr>       
