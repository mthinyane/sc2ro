...
* [sc2r:Disinformation](class-sc2rdisinformation.md)
    ...
    * sc2r:MalignRhetoric
        ...
        * [sc2r:Firehosing](class-sc2rfirehosing.md) 

        * [sc2r:GishGalloping](class-sc2rgishgalloping.md) 

        * [sc2r:Strawman](class-sc2rstrawman.md) 

        * [sc2r:Transfer](class-sc2rtransfer.md) 

        * [sc2r:WhatAboutism](class-sc2rwhataboutism.md) 
...
#### URI
http://cs.unu.edu/sc2r#MalignRhetoric
...
#### Instances of sc2r:MalignRhetoric can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:MalignRhetoric" href="class-sc2rmalignrhetoric.md" class="rdfclass">sc2r:MalignRhetoric</a></span>
            </th>
        </tr>       
