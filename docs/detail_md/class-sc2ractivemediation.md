...
#### URI
http://cs.unu.edu/sc2r#ActiveMediation
...
#### Instances of sc2r:ActiveMediation can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:ActiveMediation" href="class-sc2ractivemediation.md" class="rdfclass">sc2r:ActiveMediation</a></span>
            </th>
        </tr>       
