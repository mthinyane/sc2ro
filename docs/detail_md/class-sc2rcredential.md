...
* [sc2r:IdentifyingData](class-sc2ridentifyingdata.md)
    ...
    * sc2r:Credential
        ...
        * [sc2r:BiometricToken](class-sc2rbiometrictoken.md) 

        * [sc2r:DataToken](class-sc2rdatatoken.md) 

        * [sc2r:PhysicalToken](class-sc2rphysicaltoken.md) 
...
#### URI
http://cs.unu.edu/sc2r#Credential
...
- [sc2r:PersonalData](class-sc2rpersonaldata.md)
...
#### Instances of sc2r:Credential can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:Credential" href="class-sc2rcredential.md" class="rdfclass">sc2r:Credential</a></span>
            </th>
        </tr>       
