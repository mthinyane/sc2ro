...
#### URI
http://cs.unu.edu/sc2r#ContractBreach
...
#### Instances of sc2r:ContractBreach can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:ContractBreach" href="class-sc2rcontractbreach.md" class="rdfclass">sc2r:ContractBreach</a></span>
            </th>
        </tr>       
