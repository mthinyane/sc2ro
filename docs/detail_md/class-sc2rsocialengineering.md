...
## Class sc2r:SocialEngineering


#### Tree


* [sc2r:InfluenceThreat](class-sc2rinfluencethreat.md)

    * sc2r:SocialEngineering


        * [sc2r:Baiting](class-sc2rbaiting.md) 

        * [sc2r:Phishing](class-sc2rphishing.md) 

        * [sc2r:Pretexting](class-sc2rpretexting.md) 

        * [sc2r:QuidProQuo](class-sc2rquidproquo.md) 

        * [sc2r:Tailgating](class-sc2rtailgating.md) 
...
#### URI
http://cs.unu.edu/sc2r#SocialEngineering
...
#### Instances of sc2r:SocialEngineering can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:SocialEngineering" href="class-sc2rsocialengineering.md" class="rdfclass">sc2r:SocialEngineering</a></span>
            </th>
        </tr>       
