...
## Class sc2r:ExternalSupport


#### Tree


* [sc2r:RecoverMeasure](class-sc2rrecovermeasure.md)

    * sc2r:ExternalSupport


        * [sc2r:ProfessionalSupport](class-sc2rprofessionalsupport.md) 

        * [sc2r:SocialSupport](class-sc2rsocialsupport.md) 
...
#### URI
http://cs.unu.edu/sc2r#ExternalSupport
...
#### Instances of sc2r:ExternalSupport can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:ExternalSupport" href="class-sc2rexternalsupport.md" class="rdfclass">sc2r:ExternalSupport</a></span>
            </th>
        </tr>       
