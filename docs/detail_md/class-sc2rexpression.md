...
#### URI
http://cs.unu.edu/sc2r#Expression
...
#### Instances of sc2r:Expression can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:Expression" href="class-sc2rexpression.md" class="rdfclass">sc2r:Expression</a></span>
            </th>
        </tr>       
