...
* [sc2r:TechnologicalThreat](class-sc2rtechnologicalthreat.md)
    ...
    * sc2r:AvailabilityThreat
        ...
        * [sc2r:DenialOfService](class-sc2rdenialofservice.md) 

        * [sc2r:Disruption](class-sc2rdisruption.md) 

        * [sc2r:LostCredentials](class-sc2rlostcredentials.md) 

        * [sc2r:LostDevices](class-sc2rlostdevices.md) 

        * [sc2r:Ransomware](class-sc2rransomware.md) 
...
#### URI
http://cs.unu.edu/sc2r#AvailabilityThreat
...
#### Instances of sc2r:AvailabilityThreat can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:AvailabilityThreat" href="class-sc2ravailabilitythreat.md" class="rdfclass">sc2r:AvailabilityThreat</a></span>
            </th>
        </tr>       
