...
#### URI
http://cs.unu.edu/sc2r#SoftwareRedundancy
...
#### Instances of sc2r:SoftwareRedundancy can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:SoftwareRedundancy" href="class-sc2rsoftwareredundancy.md" class="rdfclass">sc2r:SoftwareRedundancy</a></span>
            </th>
        </tr>       
