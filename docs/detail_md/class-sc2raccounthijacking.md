...
#### URI
http://cs.unu.edu/sc2r#AccountHijacking
...
#### Instances of sc2r:AccountHijacking can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:AccountHijacking" href="class-sc2raccounthijacking.md" class="rdfclass">sc2r:AccountHijacking</a></span>
            </th>
        </tr>       
