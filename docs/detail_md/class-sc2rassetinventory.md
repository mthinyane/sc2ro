...
#### URI
http://cs.unu.edu/sc2r#AssetInventory
...
#### Instances of sc2r:AssetInventory can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:AssetInventory" href="class-sc2rassetinventory.md" class="rdfclass">sc2r:AssetInventory</a></span>
            </th>
        </tr>       
