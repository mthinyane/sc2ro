...
## Class sc2r:AuthenticationThreat
...
* [sc2r:TechnologicalThreat](class-sc2rtechnologicalthreat.md)
    ...
    * sc2r:AuthenticationThreat
        ...
        * [sc2r:AccountHijacking](class-sc2raccounthijacking.md) 

        * [sc2r:Fabrication](class-sc2rfabrication.md) 

        * [sc2r:Masquerading](class-sc2rmasquerading.md) 

        * [sc2r:Spoofing](class-sc2rspoofing.md) 

        * [sc2r:UnauthorizedAccess](class-sc2runauthorizedaccess.md) 
...
#### URI
http://cs.unu.edu/sc2r#AuthenticationThreat
...
#### Instances of sc2r:AuthenticationThreat can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:AuthenticationThreat" href="class-sc2rauthenticationthreat.md" class="rdfclass">sc2r:AuthenticationThreat</a></span>
            </th>
        </tr>       
