...
* [sc2r:Disinformation](class-sc2rdisinformation.md)
    ...
    * sc2r:InfluenceOperation
        ...
        * [sc2r:HumorAndMeme](class-sc2rhumorandmeme.md) 

        * [sc2r:Parody](class-sc2rparody.md) 

        * [sc2r:Satire](class-sc2rsatire.md) 
...
#### URI
http://cs.unu.edu/sc2r#InfluenceOperation
...
#### Instances of sc2r:InfluenceOperation can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:InfluenceOperation" href="class-sc2rinfluenceoperation.md" class="rdfclass">sc2r:InfluenceOperation</a></span>
            </th>
        </tr>       
