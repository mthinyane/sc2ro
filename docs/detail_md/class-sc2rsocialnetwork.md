...
#### URI
http://cs.unu.edu/sc2r#SocialNetwork
...
#### Instances of sc2r:SocialNetwork can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:SocialNetwork" href="class-sc2rsocialnetwork.md" class="rdfclass">sc2r:SocialNetwork</a></span>
            </th>
        </tr>       
