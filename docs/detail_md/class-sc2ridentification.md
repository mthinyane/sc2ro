...
* [sc2r:PreventionMeasure](class-sc2rpreventionmeasure.md)
    ...
    * sc2r:Identification
        ...
        * [sc2r:DeviceIdentification](class-sc2rdeviceidentification.md) 

        * [sc2r:MultiFactorAuthentication](class-sc2rmultifactorauthentication.md) 

        * [sc2r:MutualAuthentication](class-sc2rmutualauthentication.md) 

        * [sc2r:PasswordManagement](class-sc2rpasswordmanagement.md) 

        * [sc2r:UserIdentification](class-sc2ruseridentification.md) 
...
#### URI
http://cs.unu.edu/sc2r#Identification
...
#### Instances of sc2r:Identification can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:Identification" href="class-sc2ridentification.md" class="rdfclass">sc2r:Identification</a></span>
            </th>
        </tr>       
