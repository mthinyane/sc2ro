...
#### URI
http://cs.unu.edu/sc2r#SocialMediaHygiene
...
#### Instances of sc2r:SocialMediaHygiene can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:SocialMediaHygiene" href="class-sc2rsocialmediahygiene.md" class="rdfclass">sc2r:SocialMediaHygiene</a></span>
            </th>
        </tr>       
