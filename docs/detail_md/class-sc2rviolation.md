...
* [sc2r:InstitutionalThreat](class-sc2rinstitutionalthreat.md)
    ...
    * sc2r:Violation
        ...
        * [sc2r:ContractBreach](class-sc2rcontractbreach.md) 
...
#### URI
http://cs.unu.edu/sc2r#Violation
...
#### Instances of sc2r:Violation can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:Violation" href="class-sc2rviolation.md" class="rdfclass">sc2r:Violation</a></span>
            </th>
        </tr>       
