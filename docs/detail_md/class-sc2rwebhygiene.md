...
* [sc2r:PreventionMeasure](class-sc2rpreventionmeasure.md)
    ...
    * sc2r:WebHygiene
        ...
        * [sc2r:EmailHygiene](class-sc2remailhygiene.md) 

        * [sc2r:SocialMediaHygiene](class-sc2rsocialmediahygiene.md) 
...
#### URI
http://cs.unu.edu/sc2r#WebHygiene
...
#### Instances of sc2r:WebHygiene can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:WebHygiene" href="class-sc2rwebhygiene.md" class="rdfclass">sc2r:WebHygiene</a></span>
            </th>
        </tr>       
