...
#### URI
http://cs.unu.edu/sc2r#Isolation
...
#### Instances of sc2r:Isolation can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:Isolation" href="class-sc2risolation.md" class="rdfclass">sc2r:Isolation</a></span>
            </th>
        </tr>       
