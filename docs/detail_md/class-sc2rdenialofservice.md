...
#### URI
http://cs.unu.edu/sc2r#DenialOfService
...
#### Instances of sc2r:DenialOfService can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:DenialOfService" href="class-sc2rdenialofservice.md" class="rdfclass">sc2r:DenialOfService</a></span>
            </th>
        </tr>       
