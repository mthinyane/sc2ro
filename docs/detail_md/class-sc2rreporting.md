...
* [sc2r:AbsorbMeasure](class-sc2rabsorbmeasure.md)
    ...
    * sc2r:Reporting
        ...
        * [sc2r:IncidentReporting](class-sc2rincidentreporting.md) 
...
#### URI
http://cs.unu.edu/sc2r#Reporting
...
#### Instances of sc2r:Reporting can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:Reporting" href="class-sc2rreporting.md" class="rdfclass">sc2r:Reporting</a></span>
            </th>
        </tr>       
