...
#### URI
http://cs.unu.edu/sc2r#DataCorruption
...
#### Instances of sc2r:DataCorruption can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:DataCorruption" href="class-sc2rdatacorruption.md" class="rdfclass">sc2r:DataCorruption</a></span>
            </th>
        </tr>       
