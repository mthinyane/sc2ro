...
## Class sc2r:MaliciousSoftwareDetection


#### Tree


* [sc2r:ThreatMonitoringMeasure](class-sc2rthreatmonitoringmeasure.md)
...
#### URI
http://cs.unu.edu/sc2r#MaliciousSoftwareDetection
...
- [sc2r:MonitoringMeasure](class-sc2rmonitoringmeasure.md)
...
#### Instances of sc2r:MaliciousSoftwareDetection can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:MaliciousSoftwareDetection" href="class-sc2rmalicioussoftwaredetection.md" class="rdfclass">sc2r:MaliciousSoftwareDetection</a></span>
            </th>
        </tr>       
