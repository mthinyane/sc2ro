...
#### URI
http://cs.unu.edu/sc2r#ReducedPerformance
...
#### Instances of sc2r:ReducedPerformance can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:ReducedPerformance" href="class-sc2rreducedperformance.md" class="rdfclass">sc2r:ReducedPerformance</a></span>
            </th>
        </tr>       
