...
* [sc2r:Data](class-sc2rdata.md)
    ...
    * sc2r:File
        ...
        * [sc2r:CyptoCurrency](class-sc2rcyptocurrency.md) 
...
#### Instances of sc2r:File can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:File" href="class-sc2rfile.md" class="rdfclass">sc2r:File</a></span>
            </th>
        </tr>       
