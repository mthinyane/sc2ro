...
#### URI
http://cs.unu.edu/sc2r#TrustedInformation
...
#### Instances of sc2r:TrustedInformation can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:TrustedInformation" href="class-sc2rtrustedinformation.md" class="rdfclass">sc2r:TrustedInformation</a></span>
            </th>
        </tr>       
