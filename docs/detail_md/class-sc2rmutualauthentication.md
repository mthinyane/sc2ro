...
## Class sc2r:MutualAuthentication
...
#### URI
http://cs.unu.edu/sc2r#MutualAuthentication
...
#### Instances of sc2r:MutualAuthentication can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:MutualAuthentication" href="class-sc2rmutualauthentication.md" class="rdfclass">sc2r:MutualAuthentication</a></span>
            </th>
        </tr>       
