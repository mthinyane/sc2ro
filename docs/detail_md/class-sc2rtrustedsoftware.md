...
#### URI
http://cs.unu.edu/sc2r#TrustedSoftware
...
#### Instances of sc2r:TrustedSoftware can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:TrustedSoftware" href="class-sc2rtrustedsoftware.md" class="rdfclass">sc2r:TrustedSoftware</a></span>
            </th>
        </tr>       
