...
#### URI
http://cs.unu.edu/sc2r#TrustedData
...
#### Instances of sc2r:TrustedData can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:TrustedData" href="class-sc2rtrusteddata.md" class="rdfclass">sc2r:TrustedData</a></span>
            </th>
        </tr>       
