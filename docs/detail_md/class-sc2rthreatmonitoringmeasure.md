...
## Class sc2r:ThreatMonitoringMeasure
...
* [sc2r:MonitoringMeasure](class-sc2rmonitoringmeasure.md)
    ...
    * sc2r:ThreatMonitoringMeasure
        ...
        * [sc2r:FailureDetection](class-sc2rfailuredetection.md) 

        * [sc2r:IntrusionDetection](class-sc2rintrusiondetection.md) 

        * [sc2r:MaliciousSoftwareDetection](class-sc2rmalicioussoftwaredetection.md) 

        * [sc2r:SocialMediaMonitoring](class-sc2rsocialmediamonitoring.md) 
...
#### URI
http://cs.unu.edu/sc2r#ThreatMonitoringMeasure
...
#### Instances of sc2r:ThreatMonitoringMeasure can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:ThreatMonitoringMeasure" href="class-sc2rthreatmonitoringmeasure.md" class="rdfclass">sc2r:ThreatMonitoringMeasure</a></span>
            </th>
        </tr>       
