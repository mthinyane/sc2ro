...
## Class sc2r:InformationFlooding
...
#### URI
http://cs.unu.edu/sc2r#InformationFlooding
...
#### Instances of sc2r:InformationFlooding can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:InformationFlooding" href="class-sc2rinformationflooding.md" class="rdfclass">sc2r:InformationFlooding</a></span>
            </th>
        </tr>       
