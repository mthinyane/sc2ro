...
## Class sc2r:MentalFaculties


#### Tree


* [sc2r:Agency](class-sc2ragency.md)

    * sc2r:MentalFaculties


        * [sc2r:Knowledge](class-sc2rknowledge.md) 

        * [sc2r:Motivation](class-sc2rmotivation.md) 

        * [sc2r:Skills](class-sc2rskills.md) 
...
#### URI
http://cs.unu.edu/sc2r#MentalFaculties
...
#### Instances of sc2r:MentalFaculties can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:MentalFaculties" href="class-sc2rmentalfaculties.md" class="rdfclass">sc2r:MentalFaculties</a></span>
            </th>
        </tr>       
