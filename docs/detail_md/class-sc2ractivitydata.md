...
#### URI
http://cs.unu.edu/sc2r#ActivityData
...
#### Instances of sc2r:ActivityData can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:ActivityData" href="class-sc2ractivitydata.md" class="rdfclass">sc2r:ActivityData</a></span>
            </th>
        </tr>       
