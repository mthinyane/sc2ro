...
## Class sc2r:SexualAbuse


#### Tree


* [sc2r:Abuse](class-sc2rabuse.md)

    * sc2r:SexualAbuse


        * [sc2r:BoyfriendingGirlfriending](class-sc2rboyfriendinggirlfriending.md) 

        * [sc2r:Grooming](class-sc2rgrooming.md) 

        * [sc2r:LoveBombing](class-sc2rlovebombing.md) 

        * [sc2r:Luring](class-sc2rluring.md) 

        * [sc2r:Persistence](class-sc2rpersistence.md) 

        * [sc2r:Sextortion](class-sc2rsextortion.md) 

        * [sc2r:SexualAssault](class-sc2rsexualassault.md) 
...
#### URI
http://cs.unu.edu/sc2r#SexualAbuse
...
#### Instances of sc2r:SexualAbuse can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:SexualAbuse" href="class-sc2rsexualabuse.md" class="rdfclass">sc2r:SexualAbuse</a></span>
            </th>
        </tr>       
