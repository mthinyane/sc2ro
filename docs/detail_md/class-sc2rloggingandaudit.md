...
#### URI
http://cs.unu.edu/sc2r#LoggingAndAudit
...
#### Instances of sc2r:LoggingAndAudit can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:LoggingAndAudit" href="class-sc2rloggingandaudit.md" class="rdfclass">sc2r:LoggingAndAudit</a></span>
            </th>
        </tr>       
