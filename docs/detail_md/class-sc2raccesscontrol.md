...
* [sc2r:PreventionMeasure](class-sc2rpreventionmeasure.md)
    ...
    * sc2r:AccessControl
        ...
        * [sc2r:Firewall](class-sc2rfirewall.md) 

        * [sc2r:LeastPrivilege](class-sc2rleastprivilege.md) 

        * [sc2r:PhysicalRestriction](class-sc2rphysicalrestriction.md) 

        * [sc2r:Sandboxing](class-sc2rsandboxing.md) 
...
#### URI
http://cs.unu.edu/sc2r#AccessControl
...
#### Instances of sc2r:AccessControl can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:AccessControl" href="class-sc2raccesscontrol.md" class="rdfclass">sc2r:AccessControl</a></span>
            </th>
        </tr>       
