...
## Class sc2r:CapacityBuilding


#### Tree


* [sc2r:AdaptMeasure](class-sc2radaptmeasure.md)
...
#### URI
http://cs.unu.edu/sc2r#CapacityBuilding
...
#### Instances of sc2r:CapacityBuilding can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:CapacityBuilding" href="class-sc2rcapacitybuilding.md" class="rdfclass">sc2r:CapacityBuilding</a></span>
            </th>
        </tr>       
