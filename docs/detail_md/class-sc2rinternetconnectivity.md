...
## Class sc2r:InternetConnectivity
...
#### URI
http://cs.unu.edu/sc2r#InternetConnectivity
...
#### Instances of sc2r:InternetConnectivity can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:InternetConnectivity" href="class-sc2rinternetconnectivity.md" class="rdfclass">sc2r:InternetConnectivity</a></span>
            </th>
        </tr>       
