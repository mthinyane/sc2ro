...
* [sc2r:Vulnerability](class-sc2rvulnerability.md)
    ...
    * sc2r:Physical
        ...
        * [sc2r:HardwareVulnerability](class-sc2rhardwarevulnerability.md) 
...
#### Instances of sc2r:Physical can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:Physical" href="class-sc2rphysical.md" class="rdfclass">sc2r:Physical</a></span>
            </th>
        </tr>       
