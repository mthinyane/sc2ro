...
#### URI
http://cs.unu.edu/sc2r#DisruptedWork
...
#### Instances of sc2r:DisruptedWork can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:DisruptedWork" href="class-sc2rdisruptedwork.md" class="rdfclass">sc2r:DisruptedWork</a></span>
            </th>
        </tr>       
