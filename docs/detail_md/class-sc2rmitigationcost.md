...
#### URI
http://cs.unu.edu/sc2r#MitigationCost
...
#### Instances of sc2r:MitigationCost can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:MitigationCost" href="class-sc2rmitigationcost.md" class="rdfclass">sc2r:MitigationCost</a></span>
            </th>
        </tr>       
