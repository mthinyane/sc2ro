...
* [sc2r:AbsorbMeasure](class-sc2rabsorbmeasure.md)
    ...
    * sc2r:EngageMeasure
        ...
        * [sc2r:ConfrontThreat](class-sc2rconfrontthreat.md) 

        * [sc2r:DisconnectMeasure](class-sc2rdisconnectmeasure.md) 

        * [sc2r:IsolateMeasure](class-sc2risolatemeasure.md) 

        * [sc2r:RemovalMeasure](class-sc2rremovalmeasure.md) 
...
#### URI
http://cs.unu.edu/sc2r#EngageMeasure
...
#### Instances of sc2r:EngageMeasure can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:EngageMeasure" href="class-sc2rengagemeasure.md" class="rdfclass">sc2r:EngageMeasure</a></span>
            </th>
        </tr>       
