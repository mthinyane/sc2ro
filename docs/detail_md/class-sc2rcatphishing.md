...
#### URI
http://cs.unu.edu/sc2r#Catphishing
...
#### Instances of sc2r:Catphishing can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:Catphishing" href="class-sc2rcatphishing.md" class="rdfclass">sc2r:Catphishing</a></span>
            </th>
        </tr>       
