...
## Class sc2r:Electricity


#### Tree


* [sc2r:InfrastructureResource](class-sc2rinfrastructureresource.md)
...
#### URI
http://cs.unu.edu/sc2r#Electricity
...
#### Instances of sc2r:Electricity can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:Electricity" href="class-sc2relectricity.md" class="rdfclass">sc2r:Electricity</a></span>
            </th>
        </tr>       
