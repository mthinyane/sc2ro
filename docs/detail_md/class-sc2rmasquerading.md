...
#### URI
http://cs.unu.edu/sc2r#Masquerading
...
#### Instances of sc2r:Masquerading can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:Masquerading" href="class-sc2rmasquerading.md" class="rdfclass">sc2r:Masquerading</a></span>
            </th>
        </tr>       
