...
* [sc2r:Harm](class-sc2rharm.md)
    ...
    * sc2r:SocialHarm
        ...
        * [sc2r:Conflict](class-sc2rconflict.md) 

        * [sc2r:DamagedRelationship](class-sc2rdamagedrelationship.md) 

        * [sc2r:ImpairedPrivateSocialBoundary](class-sc2rimpairedprivatesocialboundary.md) 

        * [sc2r:Isolation](class-sc2risolation.md) 

        * [sc2r:Radicalisation](class-sc2rradicalisation.md) 

        * [sc2r:SocialWithdrawal](class-sc2rsocialwithdrawal.md) 
...
#### URI
http://cs.unu.edu/sc2r#SocialHarm
...
#### Instances of sc2r:SocialHarm can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:SocialHarm" href="class-sc2rsocialharm.md" class="rdfclass">sc2r:SocialHarm</a></span>
            </th>
        </tr>       
