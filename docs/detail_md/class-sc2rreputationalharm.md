...
* [sc2r:Harm](class-sc2rharm.md)
    ...
    * sc2r:ReputationalHarm
        ...
        * [sc2r:Blacklisted](class-sc2rblacklisted.md) 

        * [sc2r:DamagedSocialPerception](class-sc2rdamagedsocialperception.md) 

        * [sc2r:ReducedOpportunities](class-sc2rreducedopportunities.md) 

        * [sc2r:UnderScrutiny](class-sc2runderscrutiny.md) 
...
#### URI
http://cs.unu.edu/sc2r#ReputationalHarm
...
#### Instances of sc2r:ReputationalHarm can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:ReputationalHarm" href="class-sc2rreputationalharm.md" class="rdfclass">sc2r:ReputationalHarm</a></span>
            </th>
        </tr>       
