...
* [sc2r:IndividualResource](class-sc2rindividualresource.md)
    ...
    * sc2r:Right
        ...
        * [sc2r:Assembly](class-sc2rassembly.md) 

        * [sc2r:Expression](class-sc2rexpression.md) 

        * [sc2r:Information](class-sc2rinformation.md) 

        * [sc2r:Opinion](class-sc2ropinion.md) 
...
#### Instances of sc2r:Right can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:Right" href="class-sc2rright.md" class="rdfclass">sc2r:Right</a></span>
            </th>
        </tr>       
