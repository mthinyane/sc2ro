...
## Class sc2r:UserGeneratedContent
...
#### URI
http://cs.unu.edu/sc2r#UserGeneratedContent
...
#### Instances of sc2r:UserGeneratedContent can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:UserGeneratedContent" href="class-sc2rusergeneratedcontent.md" class="rdfclass">sc2r:UserGeneratedContent</a></span>
            </th>
        </tr>       
