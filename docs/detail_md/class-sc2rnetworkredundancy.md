...
#### URI
http://cs.unu.edu/sc2r#NetworkRedundancy
...
#### Instances of sc2r:NetworkRedundancy can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:NetworkRedundancy" href="class-sc2rnetworkredundancy.md" class="rdfclass">sc2r:NetworkRedundancy</a></span>
            </th>
        </tr>       
