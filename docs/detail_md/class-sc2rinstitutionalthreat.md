...
## Class sc2r:InstitutionalThreat


#### Tree


* [sc2r:EnvironmentalThreat](class-sc2renvironmentalthreat.md)

    * sc2r:InstitutionalThreat


        * [sc2r:Censorship](class-sc2rcensorship.md) 

        * [sc2r:Surveillance](class-sc2rsurveillance.md) 

        * [sc2r:Violation](class-sc2rviolation.md) 
...
#### URI
http://cs.unu.edu/sc2r#InstitutionalThreat
...
#### Instances of sc2r:InstitutionalThreat can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:InstitutionalThreat" href="class-sc2rinstitutionalthreat.md" class="rdfclass">sc2r:InstitutionalThreat</a></span>
            </th>
        </tr>       
