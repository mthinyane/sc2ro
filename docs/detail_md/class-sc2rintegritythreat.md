...
* [sc2r:TechnologicalThreat](class-sc2rtechnologicalthreat.md)
    ...
    * sc2r:IntegrityThreat
        ...
        * [sc2r:Damage](class-sc2rdamage.md) 

        * [sc2r:DataCorruption](class-sc2rdatacorruption.md) 

        * [sc2r:DataError](class-sc2rdataerror.md) 

        * [sc2r:Malfunction](class-sc2rmalfunction.md) 

        * [sc2r:Malware](class-sc2rmalware.md) 

        * [sc2r:Misconfiguration](class-sc2rmisconfiguration.md) 

        * [sc2r:RemoteExecution](class-sc2rremoteexecution.md) 

        * [sc2r:Replay](class-sc2rreplay.md) 

        * [sc2r:Vandalism](class-sc2rvandalism.md) 
...
#### URI
http://cs.unu.edu/sc2r#IntegrityThreat
...
#### Instances of sc2r:IntegrityThreat can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:IntegrityThreat" href="class-sc2rintegritythreat.md" class="rdfclass">sc2r:IntegrityThreat</a></span>
            </th>
        </tr>       
