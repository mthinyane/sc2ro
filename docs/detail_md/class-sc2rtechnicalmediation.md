...
#### URI
http://cs.unu.edu/sc2r#TechnicalMediation
...
#### Instances of sc2r:TechnicalMediation can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:TechnicalMediation" href="class-sc2rtechnicalmediation.md" class="rdfclass">sc2r:TechnicalMediation</a></span>
            </th>
        </tr>       
