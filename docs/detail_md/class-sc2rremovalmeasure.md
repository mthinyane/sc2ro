...
* [sc2r:EngageMeasure](class-sc2rengagemeasure.md)
    ...
    * sc2r:RemovalMeasure
        ...
        * [sc2r:MaliciousContactRemoval](class-sc2rmaliciouscontactremoval.md) 

        * [sc2r:MaliciousContentRemoval](class-sc2rmaliciouscontentremoval.md) 

        * [sc2r:MaliciousSoftwareRemoval](class-sc2rmalicioussoftwareremoval.md) 
...
#### URI
http://cs.unu.edu/sc2r#RemovalMeasure
...
#### Instances of sc2r:RemovalMeasure can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:RemovalMeasure" href="class-sc2rremovalmeasure.md" class="rdfclass">sc2r:RemovalMeasure</a></span>
            </th>
        </tr>       
