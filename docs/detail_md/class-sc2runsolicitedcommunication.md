...
## Class sc2r:UnsolicitedCommunication
...
* [sc2r:Abuse](class-sc2rabuse.md)
    ...
    * sc2r:UnsolicitedCommunication
        ...
        * [sc2r:SpamEmail](class-sc2rspamemail.md) 

        * [sc2r:UnsolicitedSocialRequest](class-sc2runsolicitedsocialrequest.md) 
...
#### URI
http://cs.unu.edu/sc2r#UnsolicitedCommunication
...
#### Instances of sc2r:UnsolicitedCommunication can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:UnsolicitedCommunication" href="class-sc2runsolicitedcommunication.md" class="rdfclass">sc2r:UnsolicitedCommunication</a></span>
            </th>
        </tr>       
