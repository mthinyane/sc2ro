...
#### URI
http://cs.unu.edu/sc2r#PhysicalToken
...
#### Instances of sc2r:PhysicalToken can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:PhysicalToken" href="class-sc2rphysicaltoken.md" class="rdfclass">sc2r:PhysicalToken</a></span>
            </th>
        </tr>       
