...
#### URI
http://cs.unu.edu/sc2r#Firehosing
...
#### Instances of sc2r:Firehosing can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:Firehosing" href="class-sc2rfirehosing.md" class="rdfclass">sc2r:Firehosing</a></span>
            </th>
        </tr>       
