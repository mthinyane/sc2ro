...
* [sc2r:PsychologicalHarm](class-sc2rpsychologicalharm.md)
    ...
    * sc2r:Confusion
        ...
        * [sc2r:Misled](class-sc2rmisled.md) 
...
#### URI
http://cs.unu.edu/sc2r#Confusion
...
#### Instances of sc2r:Confusion can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:Confusion" href="class-sc2rconfusion.md" class="rdfclass">sc2r:Confusion</a></span>
            </th>
        </tr>       
