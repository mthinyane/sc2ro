...
#### URI
http://cs.unu.edu/sc2r#PhysicalPrivacy
...
#### Instances of sc2r:PhysicalPrivacy can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:PhysicalPrivacy" href="class-sc2rphysicalprivacy.md" class="rdfclass">sc2r:PhysicalPrivacy</a></span>
            </th>
        </tr>       
