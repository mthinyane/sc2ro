...
#### URI
http://cs.unu.edu/sc2r#IdentityTheftLoss
...
#### Instances of sc2r:IdentityTheftLoss can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:IdentityTheftLoss" href="class-sc2ridentitytheftloss.md" class="rdfclass">sc2r:IdentityTheftLoss</a></span>
            </th>
        </tr>       
