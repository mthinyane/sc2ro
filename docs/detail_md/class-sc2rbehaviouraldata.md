...
#### URI
http://cs.unu.edu/sc2r#BehaviouralData
...
#### Instances of sc2r:BehaviouralData can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:BehaviouralData" href="class-sc2rbehaviouraldata.md" class="rdfclass">sc2r:BehaviouralData</a></span>
            </th>
        </tr>       
