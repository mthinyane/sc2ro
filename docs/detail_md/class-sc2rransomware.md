...
#### URI
http://cs.unu.edu/sc2r#Ransomware
...
#### Instances of sc2r:Ransomware can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:Ransomware" href="class-sc2rransomware.md" class="rdfclass">sc2r:Ransomware</a></span>
            </th>
        </tr>       
