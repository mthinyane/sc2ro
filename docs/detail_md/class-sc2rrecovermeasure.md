...
* [sc2r:Response](class-sc2rresponse.md)
    ...
    * sc2r:RecoverMeasure
        ...
        * [sc2r:AccountRecovery](class-sc2raccountrecovery.md) 

        * [sc2r:DataRecovery](class-sc2rdatarecovery.md) 

        * [sc2r:ExternalSupport](class-sc2rexternalsupport.md) 

        * [sc2r:Fact-checking](class-sc2rfact-checking.md) 

        * [sc2r:SystemRecovery](class-sc2rsystemrecovery.md) 
...
#### URI
http://cs.unu.edu/sc2r#RecoverMeasure
...
#### Instances of sc2r:RecoverMeasure can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:RecoverMeasure" href="class-sc2rrecovermeasure.md" class="rdfclass">sc2r:RecoverMeasure</a></span>
            </th>
        </tr>       
