...
* [sc2r:PrepareMeasure](class-sc2rpreparemeasure.md)
    ...
    * sc2r:MonitoringMeasure
        ...
        * [sc2r:LoggingAndAudit](class-sc2rloggingandaudit.md) 
...
#### URI
http://cs.unu.edu/sc2r#MonitoringMeasure
...
#### Instances of sc2r:MonitoringMeasure can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:MonitoringMeasure" href="class-sc2rmonitoringmeasure.md" class="rdfclass">sc2r:MonitoringMeasure</a></span>
            </th>
        </tr>       
