...
* [sc2r:Vulnerability](class-sc2rvulnerability.md)
    ...
    * sc2r:Digital
        ...
        * [sc2r:DataVulnerability](class-sc2rdatavulnerability.md) 

        * [sc2r:NetworkVulnerability](class-sc2rnetworkvulnerability.md) 

        * [sc2r:SoftwareVulnerability](class-sc2rsoftwarevulnerability.md) 
...
#### Instances of sc2r:Digital can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:Digital" href="class-sc2rdigital.md" class="rdfclass">sc2r:Digital</a></span>
            </th>
        </tr>       
