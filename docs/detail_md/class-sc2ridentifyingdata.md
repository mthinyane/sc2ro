...
* [sc2r:PersonalData](class-sc2rpersonaldata.md)
    ...
    * sc2r:IdentifyingData
        ...
        * [sc2r:Credential](class-sc2rcredential.md) 

        * [sc2r:FinancialData](class-sc2rfinancialdata.md) 
...
#### URI
http://cs.unu.edu/sc2r#IdentifyingData
...
#### Instances of sc2r:IdentifyingData can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:IdentifyingData" href="class-sc2ridentifyingdata.md" class="rdfclass">sc2r:IdentifyingData</a></span>
            </th>
        </tr>       
