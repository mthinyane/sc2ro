...
## Class sc2r:CompensationPayment
...
#### URI
http://cs.unu.edu/sc2r#CompensationPayment
...
#### Instances of sc2r:CompensationPayment can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:CompensationPayment" href="class-sc2rcompensationpayment.md" class="rdfclass">sc2r:CompensationPayment</a></span>
            </th>
        </tr>       
