...
#### URI
http://cs.unu.edu/sc2r#SpamEmail
...
#### Instances of sc2r:SpamEmail can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:SpamEmail" href="class-sc2rspamemail.md" class="rdfclass">sc2r:SpamEmail</a></span>
            </th>
        </tr>       
