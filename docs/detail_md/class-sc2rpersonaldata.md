...
* [sc2r:Data](class-sc2rdata.md)
    ...
    * sc2r:PersonalData
        ...
        * [sc2r:ActivityData](class-sc2ractivitydata.md) 

        * [sc2r:BehaviouralData](class-sc2rbehaviouraldata.md) 

        * [sc2r:DemographicInformation](class-sc2rdemographicinformation.md) 

        * [sc2r:IdentifyingData](class-sc2ridentifyingdata.md) 

        * [sc2r:LocationData](class-sc2rlocationdata.md) 

        * [sc2r:SocialContact](class-sc2rsocialcontact.md) 

        * [sc2r:UserGeneratedContent](class-sc2rusergeneratedcontent.md) 
...
#### URI
http://cs.unu.edu/sc2r#PersonalData
...
- [sc2r:DigitalResource](class-sc2rdigitalresource.md)
...
#### Instances of sc2r:PersonalData can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:PersonalData" href="class-sc2rpersonaldata.md" class="rdfclass">sc2r:PersonalData</a></span>
            </th>
        </tr>       
