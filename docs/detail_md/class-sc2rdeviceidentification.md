...
## Class sc2r:DeviceIdentification
...
#### URI
http://cs.unu.edu/sc2r#DeviceIdentification
...
#### Instances of sc2r:DeviceIdentification can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:DeviceIdentification" href="class-sc2rdeviceidentification.md" class="rdfclass">sc2r:DeviceIdentification</a></span>
            </th>
        </tr>       
