...
## Class sc2r:DamagedSocialPerception


#### Tree


* [sc2r:ReputationalHarm](class-sc2rreputationalharm.md)
...
#### URI
http://cs.unu.edu/sc2r#DamagedSocialPerception
...
#### Instances of sc2r:DamagedSocialPerception can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:DamagedSocialPerception" href="class-sc2rdamagedsocialperception.md" class="rdfclass">sc2r:DamagedSocialPerception</a></span>
            </th>
        </tr>       
