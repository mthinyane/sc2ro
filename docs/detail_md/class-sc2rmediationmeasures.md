...
* [sc2r:PrepareMeasure](class-sc2rpreparemeasure.md)
    ...
    * sc2r:MediationMeasures
        ...
        * [sc2r:ActiveMediation](class-sc2ractivemediation.md) 

        * [sc2r:RestrictiveMediation](class-sc2rrestrictivemediation.md) 

        * [sc2r:TechnicalMediation](class-sc2rtechnicalmediation.md) 
...
#### URI
http://cs.unu.edu/sc2r#MediationMeasures
...
#### Instances of sc2r:MediationMeasures can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:MediationMeasures" href="class-sc2rmediationmeasures.md" class="rdfclass">sc2r:MediationMeasures</a></span>
            </th>
        </tr>       
