...
#### URI
http://cs.unu.edu/sc2r#SocialContact
...
#### Instances of sc2r:SocialContact can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:SocialContact" href="class-sc2rsocialcontact.md" class="rdfclass">sc2r:SocialContact</a></span>
            </th>
        </tr>       
