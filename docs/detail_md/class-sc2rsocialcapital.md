...
* [sc2r:IndividualResource](class-sc2rindividualresource.md)
    ...
    * sc2r:SocialCapital
        ...
        * [sc2r:Reputation](class-sc2rreputation.md) 

        * [sc2r:SocialNetwork](class-sc2rsocialnetwork.md) 
...
#### URI
http://cs.unu.edu/sc2r#SocialCapital
...
#### Instances of sc2r:SocialCapital can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:SocialCapital" href="class-sc2rsocialcapital.md" class="rdfclass">sc2r:SocialCapital</a></span>
            </th>
        </tr>       
