...
#### URI
http://cs.unu.edu/sc2r#MobileDevice
...
#### Instances of sc2r:MobileDevice can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:MobileDevice" href="class-sc2rmobiledevice.md" class="rdfclass">sc2r:MobileDevice</a></span>
            </th>
        </tr>       
