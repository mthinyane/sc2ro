...
#### URI
http://cs.unu.edu/sc2r#AnglerPhishing
...
#### Instances of sc2r:AnglerPhishing can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:AnglerPhishing" href="class-sc2ranglerphishing.md" class="rdfclass">sc2r:AnglerPhishing</a></span>
            </th>
        </tr>       
