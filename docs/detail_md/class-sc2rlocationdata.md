...
#### URI
http://cs.unu.edu/sc2r#LocationData
...
#### Instances of sc2r:LocationData can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:LocationData" href="class-sc2rlocationdata.md" class="rdfclass">sc2r:LocationData</a></span>
            </th>
        </tr>       
