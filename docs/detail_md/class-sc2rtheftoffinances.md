...
#### URI
http://cs.unu.edu/sc2r#TheftOfFinances
...
#### Instances of sc2r:TheftOfFinances can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:TheftOfFinances" href="class-sc2rtheftoffinances.md" class="rdfclass">sc2r:TheftOfFinances</a></span>
            </th>
        </tr>       
