...
#### URI
http://cs.unu.edu/sc2r#ReserveThreat
...
#### Instances of sc2r:ReserveThreat can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:ReserveThreat" href="class-sc2rreservethreat.md" class="rdfclass">sc2r:ReserveThreat</a></span>
            </th>
        </tr>       
