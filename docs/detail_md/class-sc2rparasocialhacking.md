...
#### URI
http://cs.unu.edu/sc2r#ParasocialHacking
...
#### Instances of sc2r:ParasocialHacking can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:ParasocialHacking" href="class-sc2rparasocialhacking.md" class="rdfclass">sc2r:ParasocialHacking</a></span>
            </th>
        </tr>       
