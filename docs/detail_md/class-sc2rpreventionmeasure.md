...
* [sc2r:PrepareMeasure](class-sc2rpreparemeasure.md)
    ...
    * sc2r:PreventionMeasure
        ...
        * [sc2r:Identification](class-sc2ridentification.md) 

        * [sc2r:TrustedData](class-sc2rtrusteddata.md) 

        * [sc2r:TrustedInformation](class-sc2rtrustedinformation.md) 

        * [sc2r:TrustedInfrastructure](class-sc2rtrustedinfrastructure.md) 

        * [sc2r:TrustedSoftware](class-sc2rtrustedsoftware.md) 

        * [sc2r:WebHygiene](class-sc2rwebhygiene.md) 
...
#### URI
http://cs.unu.edu/sc2r#PreventionMeasure
...
#### Instances of sc2r:PreventionMeasure can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:PreventionMeasure" href="class-sc2rpreventionmeasure.md" class="rdfclass">sc2r:PreventionMeasure</a></span>
            </th>
        </tr>       
