...
#### URI
http://cs.unu.edu/sc2r#EngineeredContent
...
#### Instances of sc2r:EngineeredContent can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:EngineeredContent" href="class-sc2rengineeredcontent.md" class="rdfclass">sc2r:EngineeredContent</a></span>
            </th>
        </tr>       
