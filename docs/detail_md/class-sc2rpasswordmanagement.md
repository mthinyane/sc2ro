...
#### URI
http://cs.unu.edu/sc2r#PasswordManagement
...
#### Instances of sc2r:PasswordManagement can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:PasswordManagement" href="class-sc2rpasswordmanagement.md" class="rdfclass">sc2r:PasswordManagement</a></span>
            </th>
        </tr>       
