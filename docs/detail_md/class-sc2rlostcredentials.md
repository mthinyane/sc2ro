...
#### URI
http://cs.unu.edu/sc2r#LostCredentials
...
#### Instances of sc2r:LostCredentials can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:LostCredentials" href="class-sc2rlostcredentials.md" class="rdfclass">sc2r:LostCredentials</a></span>
            </th>
        </tr>       
