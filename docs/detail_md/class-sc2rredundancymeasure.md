...
## Class sc2r:RedundancyMeasure


#### Tree


* [sc2r:AnticipateMeasure](class-sc2ranticipatemeasure.md)

    * sc2r:RedundancyMeasure


        * [sc2r:DataRedundancy](class-sc2rdataredundancy.md) 

        * [sc2r:NetworkRedundancy](class-sc2rnetworkredundancy.md) 

        * [sc2r:SoftwareRedundancy](class-sc2rsoftwareredundancy.md) 

        * [sc2r:SourceRedundancy](class-sc2rsourceredundancy.md) 
...
#### URI
http://cs.unu.edu/sc2r#RedundancyMeasure
...
#### Instances of sc2r:RedundancyMeasure can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:RedundancyMeasure" href="class-sc2rredundancymeasure.md" class="rdfclass">sc2r:RedundancyMeasure</a></span>
            </th>
        </tr>       
