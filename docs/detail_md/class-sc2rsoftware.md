...
* [sc2r:DigitalResource](class-sc2rdigitalresource.md)
    ...
    * sc2r:Software
        ...
        * [sc2r:OnlineServices](class-sc2ronlineservices.md) 
...
#### Instances of sc2r:Software can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:Software" href="class-sc2rsoftware.md" class="rdfclass">sc2r:Software</a></span>
            </th>
        </tr>       
