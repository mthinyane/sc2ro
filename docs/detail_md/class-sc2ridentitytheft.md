...
#### URI
http://cs.unu.edu/sc2r#IdentityTheft
...
#### Instances of sc2r:IdentityTheft can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:IdentityTheft" href="class-sc2ridentitytheft.md" class="rdfclass">sc2r:IdentityTheft</a></span>
            </th>
        </tr>       
