...
* [sc2r:AbsorbMeasure](class-sc2rabsorbmeasure.md)
    ...
    * sc2r:WithstandMeasure
        ...
        * [sc2r:AlternativeResource](class-sc2ralternativeresource.md) 

        * [sc2r:IncreaseResources](class-sc2rincreaseresources.md) 
...
#### URI
http://cs.unu.edu/sc2r#WithstandMeasure
...
#### Instances of sc2r:WithstandMeasure can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:WithstandMeasure" href="class-sc2rwithstandmeasure.md" class="rdfclass">sc2r:WithstandMeasure</a></span>
            </th>
        </tr>       
