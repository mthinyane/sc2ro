...
* [sc2r:TrustedInfrastructure](class-sc2rtrustedinfrastructure.md)
    ...
    * sc2r:TrustedNetworking
        ...
        * [sc2r:AnonymousRouting](class-sc2ranonymousrouting.md) 

        * [sc2r:VirtualPrivateNetwork](class-sc2rvirtualprivatenetwork.md) 
...
#### URI
http://cs.unu.edu/sc2r#TrustedNetworking
...
#### Instances of sc2r:TrustedNetworking can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:TrustedNetworking" href="class-sc2rtrustednetworking.md" class="rdfclass">sc2r:TrustedNetworking</a></span>
            </th>
        </tr>       
