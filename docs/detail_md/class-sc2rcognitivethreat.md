...
* [sc2r:PersonalThreat](class-sc2rpersonalthreat.md)
    ...
    * sc2r:CognitiveThreat
        ...
        * [sc2r:DigitalHoarding](class-sc2rdigitalhoarding.md) 
        ...
        * [sc2r:Misinformation](class-sc2rmisinformation.md) 
...
#### URI
http://cs.unu.edu/sc2r#CognitiveThreat
...
#### Instances of sc2r:CognitiveThreat can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:CognitiveThreat" href="class-sc2rcognitivethreat.md" class="rdfclass">sc2r:CognitiveThreat</a></span>
            </th>
        </tr>       
