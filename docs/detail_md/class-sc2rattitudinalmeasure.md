...
* [sc2r:AnticipateMeasure](class-sc2ranticipatemeasure.md)
    ...
    * sc2r:AttitudinalMeasure
        ...
        * [sc2r:BeCritical](class-sc2rbecritical.md) 

        * [sc2r:BeSuspicious](class-sc2rbesuspicious.md) 

        * [sc2r:BeVigilant](class-sc2rbevigilant.md) 

        * [sc2r:YouAreNotImmune](class-sc2ryouarenotimmune.md) 
...
#### URI
http://cs.unu.edu/sc2r#AttitudinalMeasure
...
#### Instances of sc2r:AttitudinalMeasure can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:AttitudinalMeasure" href="class-sc2rattitudinalmeasure.md" class="rdfclass">sc2r:AttitudinalMeasure</a></span>
            </th>
        </tr>       
