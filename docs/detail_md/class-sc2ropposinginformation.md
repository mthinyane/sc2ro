...
## Class sc2r:OpposingInformation
...
#### URI
http://cs.unu.edu/sc2r#OpposingInformation
...
#### Instances of sc2r:OpposingInformation can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:OpposingInformation" href="class-sc2ropposinginformation.md" class="rdfclass">sc2r:OpposingInformation</a></span>
            </th>
        </tr>       
