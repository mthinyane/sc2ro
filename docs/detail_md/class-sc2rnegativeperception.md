...
#### URI
http://cs.unu.edu/sc2r#NegativePerception
...
#### Instances of sc2r:NegativePerception can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:NegativePerception" href="class-sc2rnegativeperception.md" class="rdfclass">sc2r:NegativePerception</a></span>
            </th>
        </tr>       
