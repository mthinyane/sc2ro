...
#### URI
http://cs.unu.edu/sc2r#YouAreNotImmune
...
#### Instances of sc2r:YouAreNotImmune can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:YouAreNotImmune" href="class-sc2ryouarenotimmune.md" class="rdfclass">sc2r:YouAreNotImmune</a></span>
            </th>
        </tr>       
