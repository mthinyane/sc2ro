...
* [sc2r:Abuse](class-sc2rabuse.md)
    ...
    * sc2r:Trolling
        ...
        * [sc2r:Sealioning](class-sc2rsealioning.md) 
...
#### Instances of sc2r:Trolling can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:Trolling" href="class-sc2rtrolling.md" class="rdfclass">sc2r:Trolling</a></span>
            </th>
        </tr>       
