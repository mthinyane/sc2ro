...
## Class sc2r:SocialMediaMonitoring
...
#### URI
http://cs.unu.edu/sc2r#SocialMediaMonitoring
...
#### Instances of sc2r:SocialMediaMonitoring can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:SocialMediaMonitoring" href="class-sc2rsocialmediamonitoring.md" class="rdfclass">sc2r:SocialMediaMonitoring</a></span>
            </th>
        </tr>       
