...
* [sc2r:Resource](class-sc2rresource.md)
    ...
    * sc2r:IndividualResource
        ...
        * [sc2r:Identity](class-sc2ridentity.md) 

        * [sc2r:Right](class-sc2rright.md) 

        * [sc2r:SocialCapital](class-sc2rsocialcapital.md) 
...
#### URI
http://cs.unu.edu/sc2r#IndividualResource
...
#### Instances of sc2r:IndividualResource can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:IndividualResource" href="class-sc2rindividualresource.md" class="rdfclass">sc2r:IndividualResource</a></span>
            </th>
        </tr>       
