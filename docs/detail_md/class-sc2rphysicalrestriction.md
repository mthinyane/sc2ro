...
## Class sc2r:PhysicalRestriction
...
#### URI
http://cs.unu.edu/sc2r#PhysicalRestriction
...
#### Instances of sc2r:PhysicalRestriction can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="sc2r:PhysicalRestriction" href="class-sc2rphysicalrestriction.md" class="rdfclass">sc2r:PhysicalRestriction</a></span>
            </th>
        </tr>       
